                        ...
                        {!connected || !rainbowInit ? (
                            ...
                            <div className="ez-flex ez-h-full ez-w-full ez-cursor-pointer">
                                ...
                                >
                                    ...
                                    <p className="ez-ml-3 ez-font-['JetBrainsMono'] ez-text-sm ez-font-normal ez-leading-[18px] ez-text-black dark:ez-text-white">
                                        {chain?.name ?? 'Chain icon'}
                                    </p>
                                </div>

                                <p
                                    className="ez-ml-3 ez-cursor-pointer ez-font-['JetBrainsMono'] ez-text-sm ez-font-normal ez-leading-[18px] ez-text-black dark:ez-text-white"
