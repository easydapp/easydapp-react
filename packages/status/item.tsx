import { proxy_query_api } from '@jellypack/runtime/lib/canisters/storage';
...
export function DappStatusContractView({
    ...
    return (
        <>
            <div
                className={cn(
                    'ez-ml-[-5px] ez-flex ez-h-10 ez-w-[28px] ez-items-center',
                    itemHover ? 'ez-z-10' : 'ez-z-0',
                )}
                onMouseEnter={() => {
                    setItemHover(true);
                }}
            ...
            >
                ...
                >
                    <Icon
                        name={doing ? 'ez-loading' : 'ez-contracts'}
                        className={cn(
                            '!ez-h-[12px] !ez-w-[12px] ez-flex-shrink-0 ez-duration-150',
                            !itemHover
                                ? doing
                                    ? 'ez-animate-spin ez-text-white'
        ...
        <>
            {url && method && (
                <div className="ez-flex ez-w-full ez-flex-col ez-items-center">
                    ...
                    <div className="ez-mt-[6px] ez-flex ez-items-center ez-justify-between ez-break-all ez-text-left ez-font-['JetBrainsMono'] ez-text-xs ez-font-normal ez-text-black dark:ez-text-white">
                        {url}
                    </div>
                </div>
            )}
        ...
        <div className="ez-flex ez-w-full ez-flex-col ez-gap-y-[6px]">
            <div className="ez-flex ez-items-center">
                ...
                <div className="ez-ml-1 ez-flex ez-flex-1 ez-items-center ez-gap-x-2">
                    {!w_caller_copied && (
                        <div className="ez-flex ez-flex-1 ez-truncate ez-font-['JetBrainsMono'] ez-text-xs ez-font-normal ez-text-black dark:ez-text-white">
                            {w_caller}
                        </div>
                    )}
                    {w_caller_copied && (
        ...
        <>
            {
                <div className="ez-flex ez-items-center ez-justify-between">
                    <div className="ez-flex ez-items-center ez-justify-start">
                        ...
                        <div className="ez-ml-2 ez-flex ez-items-center ez-justify-center ez-font-['JetBrainsMono'] ez-text-xs ez-font-normal ez-leading-snug ez-text-black dark:ez-text-white">
                            {method ?? '?'}
                        </div>
                    </div>
...
function ShowEvmChainView({ chain }: { chain: EvmChain }) {
    return (
        <div className="ez-flex ez-w-full ez-items-center">
            <Label title="Chain" />
            <div className="ez-ml-1 ez-flex ez-font-['JetBrainsMono'] ez-text-xs ez-font-normal ez-text-black dark:ez-text-white">
                {chain}
            </div>
        </div>
    );
...
function ShowEvmAccountView({
    ...
    return (
        <div className="ez-flex ez-items-center ez-justify-start">
            ...
            <div className="ez-ml-1 ez-flex ez-flex-1 ez-items-center ez-gap-x-2 ez-truncate ez-font-['JetBrainsMono'] ez-text-xs ez-font-normal ez-text-black dark:ez-text-white">
...
function ShowEvmContractView({ chain, contract }: { chain: EvmChain; contract: string }) {
    ...
    return (
        <div className="ez-flex ez-items-center ez-justify-start">
            ...
            <div className="ez-ml-1 ez-flex ez-items-center ez-justify-center ez-gap-x-2 ez-font-['JetBrainsMono'] ez-text-xs ez-font-normal ez-leading-snug ez-text-black dark:ez-text-white">
        ...
        <>
            {
                <div className="ez-flex ez-flex-col ez-gap-y-[6px]">
                    ...
                    <div className="ez-items-left ez-flex ez-w-full ez-gap-x-2 ez-font-['JetBrainsMono'] ez-text-xs ez-font-normal ez-leading-snug ez-text-black dark:ez-text-white">
                        {message ?? '?'}
