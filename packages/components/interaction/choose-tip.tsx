        ...
        >
            {
                ...
                values !== undefined && value !== undefined && (
                    <div className={`ez-flex ez-h-11 ez-w-full ez-flex-shrink-0 ez-flex-col`}>
                        <div className="ez-flex ez-h-full ez-w-full ez-flex-row ez-items-center ez-justify-between ez-rounded-lg !ez-border ez-border-[#ddd] ez-px-2 ez-py-1 dark:ez-border-[#333]">
                            <div className="ez-text-medium ez-font-['JetBrainsMono'] ez-text-[12px] ez-text-black dark:ez-text-white">
                                    ...
                                    {values[0].map((item, index) => (
                                        <Option key={index}>
                                            <div className="ez-flex ez-h-[30px] ez-cursor-pointer ez-items-center ez-justify-between ez-px-[0px]">
                                                <span className="ez-font-['JetBrainsMono'] ez-text-[12px] ez-font-medium ez-text-black dark:ez-text-white">
                                                    {item}
                                                </span>
                                                <span className="ez-font-['JetBrainsMono'] ez-text-[12px] ez-font-normal ez-leading-[18px] ez-text-[#666666] dark:ez-text-[#999]">
